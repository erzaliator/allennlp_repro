...
# define macros
lang = 'fas'
BERT_MODEL = 'HooshvareLab/bert-fa-base-uncased' #'dbmdz/bert-base-german-cased'
# 'bert-base-multilingual-cased'
# 'bert-base-uncased'

batch_size = 4
batches_per_epoch = 1025

save_path_suffix = '17_refactor_delete_activation_config_usegelu_lr=1e-6_fas_'
