...
from featureful_bert_custom import FeaturefulBert
...
class FeaturefulBertEmbedder(TokenEmbedder):
    ...
    def init_feature_modules(self):
        self.transformer_model.init_feature_modules()
    ...
    def forward(
        ...
        **kwargs
        ...
        parameters = {"input_ids": token_ids, "attention_mask": transformer_mask.float(), "direction_tensor": torch.squeeze(direction_tensor,1)}
        # add features
