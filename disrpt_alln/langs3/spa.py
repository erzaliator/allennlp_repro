...
# define macros
lang = 'spa.rst.sctb'
BERT_MODEL = 'dccuchile/bert-base-spanish-wwm-cased' #'dbmdz/bert-base-german-cased'
# 'bert-base-multilingual-cased'
# 'bert-base-uncased'

batch_size = 4
batches_per_epoch = 110
save_path_suffix = '17_refactor_delete_activation_config_usegelu_lr=1e-6_spa_'
