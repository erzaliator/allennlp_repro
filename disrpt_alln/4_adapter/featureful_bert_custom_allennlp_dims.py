...
from features_custom_allennlp_dims import get_combined_feature_tensor_2, get_feature_modules
...
class FeaturefulBert(BertPreTrainedModel):
    ...
    def init_feature_modules(self, feature_list, vocab, use_allen_dims=True):
        ...
        if feature_list is not None and len(feature_list) > 0:
            feature_modules, feature_dims = get_feature_modules(feature_list, vocab, use_allen_dims)
