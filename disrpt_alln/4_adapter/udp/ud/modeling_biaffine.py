...
from transformers import AutoModel, BertPreTrainedModel, ModelWithHeadsAdaptersMixin
...
class TransformerForBiaffineParsing(ModelWithHeadsAdaptersMixin, BertPreTrainedModel):
    ...
    def __init__(self, config, name_or_path=None):
        super().__init__(config)
        base_model = AutoModel.from_pretrained(name_or_path)
        if base_model.base_model_prefix == 'roberta':
