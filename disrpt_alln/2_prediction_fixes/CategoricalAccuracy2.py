...
@Metric.register("categorical_accuracy_custom")
class CategoricalAccuracy(Metric):
    ...
    def __init__(self, top_k: int = 1, tie_break: bool = False, num_classes_override: Optional[int] = -1) -> None:
        ...
        self.num_classes_override = num_classes_override
    ...
    def __call__(
        ...
        if self.num_classes_override==-1:
