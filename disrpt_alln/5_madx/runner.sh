# nohup python 01_madx_samepre1.py --lang1_index=0 --cuda=5 > logs_runtime/runtime_0.out 2> logs_runtime/runtime_0.err &
# nohup python 01_madx_samepre1.py --lang1_index=1 --cuda=4 > logs_runtime/runtime_1.out 2> logs_runtime/runtime_1.err &
