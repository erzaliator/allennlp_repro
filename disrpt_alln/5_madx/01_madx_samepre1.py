...
additional_info = 'CheckFullShot=v5'
name = '_'.join([additional_info, 'pretrain', dataset1, lrfunc, model_name])


# output data params
MODEL_DIR = 'runs/full_shot/same_pretrain/'+name
# print('-------------------------------------------------------------------')
...
for dataset2 in lang_list:
    if dataset1 == dataset2:
        continue
    if dataset2 in ['deu.rst.pcc', 'eng.pdtb.pdtb', 'eng.rst.gum', 'eng.rst.rstdt', 'eng.sdrt.stac', 'fas.rst.prstc', 'fra.sdrt.annodis', 'nld.rst.nldt']:
        continue
