...
class CustomBERTModel(nn.Module):
    ...
    def __init__(self, num_labels):
          ...
          ### New layers:
          self.linear1 = nn.Linear(768, 512)#776
          ...
          self.act2 = nn.ReLU()
          self.act3 = nn.ReLU()
          self.drop = nn.Dropout(0.1)  # can i use the same dropout object everywhere?
    ...
    def forward(self, pair_token_ids, token_type_ids, attention_mask, feat):
        ...
        linear1_output = self.linear1(sequence_output) ## extract the 1st token's embeddings
